				...
				<tr>
					<td style="width:400px;padding:0px;">
						<div class="form-group">
							...
							<div class="col-sm-7">
								<select class="input-sm"  name="stategicInitiativeType" style="height:24px;padding: 1px 3px;" disabled="disabled">
									<option value="">--Select Record Type--</option>
									<option value="${selectedOptionValue}" selected>Strategic Goal</option>
								</select>
							</div>
						</div>
					</td>
